...
import threading
import weakref
from typing import Callable, List, Tuple, Any, Dict, Set, Optional, Union, Type
    ...
    def clear(self):
        ...
        with self._lock:
            ...
            if self._cache:
                ...
                self._cache._access_times.clear()
...
def auto_contract(func):
    ...
    for param_name, param in sig.parameters.items():
        if param.annotation != inspect.Parameter.empty:
            ...
            def make_precondition(pt, pn):
                def check_type(*args, **kwargs):
                    value = kwargs.get(pn)
                    if value is None and list(sig.parameters.keys()).index(pn) < len(args):
                        value = args[list(sig.parameters.keys()).index(pn)]
            ...
            preconditions.append((
                ...
                make_precondition(param_type, param_name)
            ))
