"""
PyProof: Performant Runtime Verification for Python with Future Features
...
def demo_future_features():
    ...
    print("PyProof Future: Runtime Verification with Adaptive Monitoring, Introspection & Recovery")
    print("~" * 90)
