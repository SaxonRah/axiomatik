...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// VERIFICATION REPORTING AND DEBUGGING
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

// Reporting configuration
typedef struct
{
	bool show_all_verifications;
	bool show_failures_only;
	bool show_context_changes;
	bool show_performance_stats;
	bool show_summaries;
	FILE* output_file; // NULL for stdout
} verification_report_config_t;

// Global reporting configuration
extern verification_report_config_t global_report_config;
...
#define REQUIRE( claim, condition )                                                                                              \
	do                                                                                                                           \
	{                                                                                                                            \
		if ( !require_bool( claim, condition ) )                                                                                 \
		{                                                                                                                        \
...
#define REQUIRE_RETURN( claim, condition, retval )                                                                               \
	do                                                                                                                           \
	{                                                                                                                            \
		if ( !require_bool( claim, condition ) )                                                                                 \
		{                                                                                                                        \
...
// Updated macros to handle require_bool style usage
#define PRECONDITION( desc, condition )                                                                                          \
	do                                                                                                                           \
	{                                                                                                                            \
		if ( !( condition ) )                                                                                                    \
		{                                                                                                                        \
			printf( "Precondition failed: %s\n", desc );                                                                         \
			destroy_contract( _contract );                                                                                       \
			return (b2DistanceOutput){ 0 };                                                                                      \
		}                                                                                                                        \
	}                                                                                                                            \
	while ( 0 )

#define POSTCONDITION( desc, condition )                                                                                         \
	do                                                                                                                           \
	{                                                                                                                            \
		if ( !( condition ) )                                                                                                    \
		{                                                                                                                        \
...
// Alternative versions for functions that return void
#define PRECONDITION_VOID( desc, condition )                                                                                     \
	do                                                                                                                           \
	{                                                                                                                            \
		if ( !( condition ) )                                                                                                    \
		{                                                                                                                        \
...
#define POSTCONDITION_VOID( desc, condition )                                                                                    \
	do                                                                                                                           \
	{                                                                                                                            \
		if ( !( condition ) )                                                                                                    \
		{                                                                                                                        \
...
#define CHECK_PRECONDITIONS() true	// Simplified since we check inline now
#define CHECK_POSTCONDITIONS() true // Simplified since we check inline now
#define CONTRACT_END() destroy_contract( _contract )
...
// Safe string copy that works with both MSVC and GCC
